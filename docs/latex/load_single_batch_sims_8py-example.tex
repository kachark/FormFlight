...
\DoxyCodeLine{32 }
\DoxyCodeLine{33     dim = 2}
\DoxyCodeLine{34 }
\DoxyCodeLine{35     nagents = 2}
\DoxyCodeLine{36     ntargets = 2}
\DoxyCodeLine{37 }
\DoxyCodeLine{38     agent\_model = \textcolor{stringliteral}{'Double\_Integrator'}}
\DoxyCodeLine{39     target\_model = \textcolor{stringliteral}{'Double\_Integrator'}}
...
\DoxyCodeLine{42 }
\DoxyCodeLine{43     \textcolor{comment}{\# agent\_model = 'Linearized\_Quadcopter'}}
\DoxyCodeLine{44     \textcolor{comment}{\# target\_model = 'Linearized\_Quadcopter'}}
...
\DoxyCodeLine{46             \textcolor{stringliteral}{'identical\_'}+agent\_model+\textcolor{stringliteral}{'\_LQR\_LQR\_2019\_08\_23\_14\_06\_58'}}
\DoxyCodeLine{47 }
\DoxyCodeLine{48     root\_directory = \textcolor{stringliteral}{'/Users/koray/Documents/GradSchool/research/gorodetsky/draper/sandbox/targetingmdp/'}}
