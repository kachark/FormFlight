...
\DoxyCodeLine{292 }
\DoxyCodeLine{293 }
\DoxyCodeLine{294 \textcolor{keyword}{def }secondsToStr(elapsed=None):}
\DoxyCodeLine{295 }
\DoxyCodeLine{296     \textcolor{stringliteral}{""" Converts seconds to strings}}
\DoxyCodeLine{297 \textcolor{stringliteral}{}}
\DoxyCodeLine{298 \textcolor{stringliteral}{    """}}
\DoxyCodeLine{299 }
\DoxyCodeLine{300     \textcolor{keywordflow}{if} elapsed \textcolor{keywordflow}{is} \textcolor{keywordtype}{None}:}
\DoxyCodeLine{301         \textcolor{keywordflow}{return} strftime(\textcolor{stringliteral}{"\%Y-\%m-\%d \%H:\%M:\%S"}, localtime())}
\DoxyCodeLine{302     \textcolor{keywordflow}{else}:}
\DoxyCodeLine{303         \textcolor{keywordflow}{return} str(timedelta(seconds=elapsed))}
\DoxyCodeLine{304 }
\DoxyCodeLine{305 \textcolor{keyword}{def }log(s, elapsed=None):}
\DoxyCodeLine{306 }
\DoxyCodeLine{307     \textcolor{stringliteral}{""" start logging of elapsed time}}
\DoxyCodeLine{308 \textcolor{stringliteral}{}}
\DoxyCodeLine{309 \textcolor{stringliteral}{    """}}
\DoxyCodeLine{310 }
\DoxyCodeLine{311     line = \textcolor{stringliteral}{"="}*40}
\DoxyCodeLine{312     print(line)}
\DoxyCodeLine{313     print(secondsToStr(), \textcolor{stringliteral}{'-'}, s)}
\DoxyCodeLine{314     ss = secondsToStr() + \textcolor{stringliteral}{' - '} + s}
\DoxyCodeLine{315     \textcolor{keywordflow}{if} elapsed:}
\DoxyCodeLine{316         print(\textcolor{stringliteral}{"Elapsed time:"}, elapsed)}
\DoxyCodeLine{317     print(line)}
\DoxyCodeLine{318     print()}
\DoxyCodeLine{319     \textcolor{keywordflow}{return} ss}
\DoxyCodeLine{320 }
\DoxyCodeLine{321 \textcolor{keyword}{def }endlog():}
\DoxyCodeLine{322 }
\DoxyCodeLine{323     \textcolor{stringliteral}{""" end log of elapsed time}}
\DoxyCodeLine{324 \textcolor{stringliteral}{}}
\DoxyCodeLine{325 \textcolor{stringliteral}{    """}}
\DoxyCodeLine{326 }
\DoxyCodeLine{327     end = time()}
\DoxyCodeLine{328     elapsed = end-start}
\DoxyCodeLine{329     log(\textcolor{stringliteral}{"End Program"}, secondsToStr(elapsed))}
\DoxyCodeLine{330 }
\DoxyCodeLine{331 }
\DoxyCodeLine{332 \textcolor{keywordflow}{if} \_\_name\_\_ == \textcolor{stringliteral}{"\_\_main\_\_"}:}
\DoxyCodeLine{333 }
\DoxyCodeLine{334     start = time()}
\DoxyCodeLine{335     \textcolor{comment}{\# atexit.register(endlog) \# print end time at program termination}}
\DoxyCodeLine{336     starttime = log(\textcolor{stringliteral}{"Start Program"})}
\DoxyCodeLine{337 }
\DoxyCodeLine{338     \textcolor{comment}{\# PERFORM TEST}}
\DoxyCodeLine{339     test\_conditions = main()}
\DoxyCodeLine{340 }
\DoxyCodeLine{341     ensemble\_name = test\_conditions[\textcolor{stringliteral}{'ensemble\_name'}]}
\DoxyCodeLine{342     ensemble\_directory = test\_conditions[\textcolor{stringliteral}{'ensemble\_directory'}]}
\DoxyCodeLine{343 }
\DoxyCodeLine{344     \textcolor{comment}{\# PRINT TEST INFO TO TERMINAL}}
\DoxyCodeLine{345     print()}
\DoxyCodeLine{346     line = \textcolor{stringliteral}{"*"}*40}
\DoxyCodeLine{347     print(line)}
\DoxyCodeLine{348     \textcolor{keywordflow}{for} condition, value \textcolor{keywordflow}{in} test\_conditions.items():}
\DoxyCodeLine{349         print(condition, \textcolor{stringliteral}{': '}, value)}
\DoxyCodeLine{350     print(line)}
\DoxyCodeLine{351     print()}
\DoxyCodeLine{352 }
\DoxyCodeLine{353     \textcolor{comment}{\# display starttime at the end as well as beginning}}
\DoxyCodeLine{354     line = \textcolor{stringliteral}{"="}*40}
\DoxyCodeLine{355     print(line)}
\DoxyCodeLine{356     print(starttime)}
\DoxyCodeLine{357     print(line)}
\DoxyCodeLine{358     print()}
\DoxyCodeLine{359 }
\DoxyCodeLine{360     end = time() \textcolor{comment}{\# print end time at end of simulation}}
\DoxyCodeLine{361     elapsed = end-start}
\DoxyCodeLine{362     elapsedstr = secondsToStr(elapsed)}
\DoxyCodeLine{363     endtime = log(\textcolor{stringliteral}{"End Program"}, elapsedstr)}
\DoxyCodeLine{364 }
\DoxyCodeLine{365     save\_test\_info\_to\_txt(ensemble\_name, test\_conditions, ensemble\_directory, starttime, endtime, elapsedstr)}
\DoxyCodeLine{366 }
\end{DoxyCodeInclude}
