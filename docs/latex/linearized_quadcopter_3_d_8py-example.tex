...
\DoxyCodeLine{47 }
\DoxyCodeLine{48     \textcolor{stringliteral}{""" Linearized quadcopter agent and target swarms in 3D}}
...
\DoxyCodeLine{79     dim = 3}
\DoxyCodeLine{80     nagents = 2}
\DoxyCodeLine{81     ntargets = 2}
\DoxyCodeLine{82     agent\_model = \textcolor{stringliteral}{"Linearized\_Quadcopter"}}
\DoxyCodeLine{83     target\_model = \textcolor{stringliteral}{"Linearized\_Quadcopter"}}
