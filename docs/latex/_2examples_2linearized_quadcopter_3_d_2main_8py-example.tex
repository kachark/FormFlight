\hypertarget{_2examples_2linearized_quadcopter_3_d_2main_8py-example}{}\section{/examples/linearized\+\_\+quadcopter\+\_\+3\+D/main.\+py}
...
\DoxyCodeLine{86     nagents = 5}
\DoxyCodeLine{87     ntargets = 5}
...
\DoxyCodeLine{103             \textcolor{stringliteral}{'identical\_'}+agent\_model+\textcolor{stringliteral}{'\_LQR\_LQR\_LINEARIZED\_QUADCOPTER\_3D\_EXAMPLE'}}
\DoxyCodeLine{104 }
...
\DoxyCodeLine{295 }
\DoxyCodeLine{296 \textcolor{keyword}{def }secondsToStr(elapsed=None):}
\DoxyCodeLine{297 }
\DoxyCodeLine{298     \textcolor{stringliteral}{""" Converts seconds to strings}}
\DoxyCodeLine{299 \textcolor{stringliteral}{}}
\DoxyCodeLine{300 \textcolor{stringliteral}{    """}}
\DoxyCodeLine{301 }
\DoxyCodeLine{302     \textcolor{keywordflow}{if} elapsed \textcolor{keywordflow}{is} \textcolor{keywordtype}{None}:}
\DoxyCodeLine{303         \textcolor{keywordflow}{return} strftime(\textcolor{stringliteral}{"\%Y-\%m-\%d \%H:\%M:\%S"}, localtime())}
\DoxyCodeLine{304     \textcolor{keywordflow}{else}:}
\DoxyCodeLine{305         \textcolor{keywordflow}{return} str(timedelta(seconds=elapsed))}
\DoxyCodeLine{306 }
\DoxyCodeLine{307 \textcolor{keyword}{def }log(s, elapsed=None):}
\DoxyCodeLine{308 }
\DoxyCodeLine{309     \textcolor{stringliteral}{""" start logging of elapsed time}}
\DoxyCodeLine{310 \textcolor{stringliteral}{}}
\DoxyCodeLine{311 \textcolor{stringliteral}{    """}}
\DoxyCodeLine{312 }
\DoxyCodeLine{313     line = \textcolor{stringliteral}{"="}*40}
\DoxyCodeLine{314     print(line)}
\DoxyCodeLine{315     print(secondsToStr(), \textcolor{stringliteral}{'-'}, s)}
\DoxyCodeLine{316     ss = secondsToStr() + \textcolor{stringliteral}{' - '} + s}
\DoxyCodeLine{317     \textcolor{keywordflow}{if} elapsed:}
\DoxyCodeLine{318         print(\textcolor{stringliteral}{"Elapsed time:"}, elapsed)}
\DoxyCodeLine{319     print(line)}
\DoxyCodeLine{320     print()}
\DoxyCodeLine{321     \textcolor{keywordflow}{return} ss}
\DoxyCodeLine{322 }
\DoxyCodeLine{323 \textcolor{keyword}{def }endlog():}
\DoxyCodeLine{324 }
\DoxyCodeLine{325     \textcolor{stringliteral}{""" end log of elapsed time}}
\DoxyCodeLine{326 \textcolor{stringliteral}{}}
\DoxyCodeLine{327 \textcolor{stringliteral}{    """}}
\DoxyCodeLine{328 }
\DoxyCodeLine{329     end = time()}
\DoxyCodeLine{330     elapsed = end-start}
\DoxyCodeLine{331     log(\textcolor{stringliteral}{"End Program"}, secondsToStr(elapsed))}
\DoxyCodeLine{332 }
\DoxyCodeLine{333 }
\DoxyCodeLine{334 \textcolor{keywordflow}{if} \_\_name\_\_ == \textcolor{stringliteral}{"\_\_main\_\_"}:}
\DoxyCodeLine{335 }
\DoxyCodeLine{336     start = time()}
\DoxyCodeLine{337     \textcolor{comment}{\# atexit.register(endlog) \# print end time at program termination}}
\DoxyCodeLine{338     starttime = log(\textcolor{stringliteral}{"Start Program"})}
\DoxyCodeLine{339 }
\DoxyCodeLine{340     \textcolor{comment}{\# PERFORM TEST}}
\DoxyCodeLine{341     test\_conditions = \mbox{\hyperlink{namespacemain}{main}}()}
\DoxyCodeLine{342 }
\DoxyCodeLine{343     ensemble\_name = test\_conditions[\textcolor{stringliteral}{'ensemble\_name'}]}
\DoxyCodeLine{344     ensemble\_directory = test\_conditions[\textcolor{stringliteral}{'ensemble\_directory'}]}
\DoxyCodeLine{345 }
\DoxyCodeLine{346     \textcolor{comment}{\# PRINT TEST INFO TO TERMINAL}}
\DoxyCodeLine{347     print()}
\DoxyCodeLine{348     line = \textcolor{stringliteral}{"*"}*40}
\DoxyCodeLine{349     print(line)}
\DoxyCodeLine{350     \textcolor{keywordflow}{for} condition, value \textcolor{keywordflow}{in} test\_conditions.items():}
\DoxyCodeLine{351         print(condition, \textcolor{stringliteral}{': '}, value)}
\DoxyCodeLine{352     print(line)}
\DoxyCodeLine{353     print()}
\DoxyCodeLine{354 }
\DoxyCodeLine{355     \textcolor{comment}{\# display starttime at the end as well as beginning}}
\DoxyCodeLine{356     line = \textcolor{stringliteral}{"="}*40}
\DoxyCodeLine{357     print(line)}
\DoxyCodeLine{358     print(starttime)}
\DoxyCodeLine{359     print(line)}
\DoxyCodeLine{360     print()}
\DoxyCodeLine{361 }
\DoxyCodeLine{362     end = time() \textcolor{comment}{\# print end time at end of simulation}}
\DoxyCodeLine{363     elapsed = end-start}
\DoxyCodeLine{364     elapsedstr = secondsToStr(elapsed)}
\DoxyCodeLine{365     endtime = log(\textcolor{stringliteral}{"End Program"}, elapsedstr)}
\DoxyCodeLine{366 }
\DoxyCodeLine{367     save\_test\_info\_to\_txt(ensemble\_name, test\_conditions, ensemble\_directory, starttime, endtime, elapsedstr)}
\DoxyCodeLine{368 }
\end{DoxyCodeInclude}
